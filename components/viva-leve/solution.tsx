    ...
    <section id="servicos" className="py-16 lg:py-24 bg-viva-beige">
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-12 ${isInView ? 'animate-fade-in-up' : 'opacity-0'}`}>
          <h2 className="text-3xl sm:text-4xl font-bold text-viva-dark-green text-balance max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {solutions.map((solution, index) => (
            <div
              key={solution.title}
              className={`group bg-white rounded-2xl overflow-hidden border-t-4 border-t-viva-sage hover:shadow-xl hover:shadow-viva-sage/10 transition-all duration-300 ${
            ...
            >
              ...
              />
              <div className="p-6">
                <div className="w-12 h-12 bg-viva-sage/10 rounded-xl flex items-center justify-center mb-4">
                  <solution.icon className="w-6 h-6 text-viva-sage" />
                </div>
